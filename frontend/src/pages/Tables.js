    ...
    <div className="p-8 max-w-[1400px] mx-auto">
      <div className="flex items-end justify-between mb-8 flex-wrap gap-4">
        <div>
          ...
          <h1 className="font-serif-display text-5xl">{t("nav.tables")}</h1>
        </div>
            ...
            {addingTableTo === area.id && (
              <div className="p-4 border-b border-zinc-100 bg-zinc-50/50 grid grid-cols-2 md:grid-cols-7 gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => setAddingTableTo(null)} className="p-1.5 rounded-md hover:bg-zinc-100"><X size={16} /></button>
                </div>
              </div>
            )}
